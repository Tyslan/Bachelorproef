...
% %\input{source.tex}
\chapter{Opzetten vagrant Cassandra single node}
\label{ch:vagrant_single}
\section{Vagrantfile}
\lstinputlisting[language=Ruby]{./code/vagrant-single/Vagrantfile.rb}
\clearpage

\section{Setup}
\lstinputlisting[language=Bash, breaklines=true]{./code/vagrant-single/setup.sh}
\clearpage

\chapter{Opzetten vagrant Cassandra cluster}
\label{ch:vagrant_cluster}

\section{/etc/hosts}
\lstinputlisting{./code/vagrant-multi/hosts.txt}
\clearpage

\section{Vagrantfile}
\lstinputlisting[language=Ruby]{./code/vagrant-multi/Vagrantfile.rb}
\clearpage

\section{Setup cluster manager }
\lstinputlisting[language=Bash, breaklines=true]{./code/vagrant-multi/setup_dse.sh}
\clearpage

\section{Setup slaves }
\lstinputlisting[language=Bash, breaklines=true]{./code/vagrant-multi/setup_slave.sh}
\clearpage
\end{document}
