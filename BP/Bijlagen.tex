...
% %\input{source.tex}
\chapter{Opzetten vagrant cluster}
\label{ch:vagrant_cluster}

\section{/etc/hosts}
\lstinputlisting{./code/vagrant/hosts.txt}
\clearpage

\section{Vagrantfile}
\lstinputlisting[language=Ruby]{./code/vagrant/Vagrantfile.rb}
\clearpage

\section{Setup cluster manager }
\lstinputlisting[language=Bash, breaklines=true]{./code/vagrant/setup_dse.sh}
\clearpage

\section{Setup slaves }
\lstinputlisting[language=Bash, breaklines=true]{./code/vagrant/setup_slave.sh}
\clearpage
\end{document}
