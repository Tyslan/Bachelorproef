...
Aan de hand van figuur \ref{fig:column} en \ref{fig:datastructure} kan verklaard worden waarom Cassandra tot de Column Family Store behoort, terwijl er toch sprake is van rijen.
...
\begin{figure}[H]
	...
	\caption{Logische datastructuren in Cassandra \citep{Antunez2015DataStructures}}
