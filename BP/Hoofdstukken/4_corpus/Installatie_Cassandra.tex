...
Ook dient vermeld te worden dat het OpsCenter van DataStax niet de enige manier is om de cluster te monitoren.
Cassandra voorziet zelf de tool nodetool hiervoor.
Met deze tool kan de status van de cluster eveneens opgevraagd worden.